...
//           {/* Company Info */}
//           <div>
//             <h3 className="text-xl font-bold mb-4">ClouSec</h3>
//             <p className="text-gray-300 mb-4">
//               Securing your cloud infrastructure with advanced security solutions.
//             </p>
...
//               </li>
//               <li>
//                 <Link to="/blogs" className="text-gray-300 hover:text-white transition duration-300">
//                   Blog
//                 </Link>
//               </li>
//               <li>
//                 <Link to="/case-studies" className="text-gray-300 hover:text-white transition duration-300">
//                   Case Studies
//                 </Link>
//               </li>
//               <li>
//                 <Link to="/docs" className="text-gray-300 hover:text-white transition duration-300">
//                   Documentation
//                 </Link>
//               </li>
//             </ul>
...
//             &copy; {currentYear} ClouSec. All rights reserved.
//           </p>
//         </div>
//       </div>
//     </footer>
...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white overflow-hidden ">
      <div className="container mx-auto px-4 md:px-6 py-12  z-1">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
          {/* Logo and About */}
          <div className="space-y-4">
            <Link to="/" className="inline-block bg-white p-2 ">
              <img src="/logo.png" alt="ClouSec Logo" className="h-12" />
            </Link>
            ...
            <div className="flex space-x-4">
             ...
             <h3 className="text-lg font-semibold  mb-4 mt-3  border-b border-gray-700 pb-2">Backed up by</h3>
            <img src="/ssnlogo.png" width={150} alt="ssnlogo" />
          </div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                <p className="flex flex-col">
                  <span className="font-medium text-orange-400 ">India:</span>
              ...
              <li>
                <p className="flex flex-col">
                  <span className="font-medium text-orange-400">USA:</span>
             ...
             <div className="flex flex-wrap flex-col">
               ...
               <li>
                <a href="tel:+919790845787" className="hover:text-white transition-colors">+91 9790845787</a><br/>
              </li> 
               <li>
