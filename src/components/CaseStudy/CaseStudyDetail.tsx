...
const CaseStudyDetail: React.FC = () => {
  ...
  return (
   <>
     <Helmet>
               <title>{caseStudy.title} | ClouSec</title>
             </Helmet>
            ...
            {caseStudy.pdfUrl && (
              <div className="mt-8 border-t pt-6">
                <button 
                  ...
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-md transition duration-300"
                >
