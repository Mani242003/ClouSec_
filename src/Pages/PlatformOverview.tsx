...
const PlatformOverview: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
                <title>Platform Overview | ClouSec</title>
              </Helmet>
 ...
 {/* <section className=" py-14 px-4 text-center ">
   ...
   <div className="max-w-6xl mx-auto pt-10">
     <h2 className="text-3xl md:text-4xl font-bold text-center  text-gray-900 ">
      Why Smart People Pick ClouSec

     </h2>
     <p className="font-poppins font-normal text-gray-800 text-[18px] leading-[30.8px]  mt-5 text-center mb-10">
      Gartner predicts that the vast majority of cloud security failures stem from preventable user errors. Misconfigurations, weak passwords, and a lack of understanding of the shared responsibility model are leaving organizations vulnerable. ClouSec provides automated configuration checks, user access management, and training resources to minimize human error.
